...
public class BlueprintsServices {
    ...
    //@Qualifier("BlueprintFiltroRedundancia")
    @Autowired
    ...
    public void addNewBlueprint(Blueprint bp) throws BlueprintFiltroException{
    ...
    public Blueprint getBlueprint(String author,String name) throws BlueprintNotFoundException, BlueprintFiltroException{
        return filtro.filtrarBlueprint(bpp.getBlueprint(author, name));
    }
    ...
    public Set<Blueprint> getBlueprintsByAuthor(String author) throws BlueprintNotFoundException, BlueprintFiltroException{
        return filtro.filtrarBlueprints(bpp.getBlueprintByAuthor(author));
    }
